...
<body>
		...
		<div class="checkbox1">
			<div class="checkbox"  id ="bloque1">
				...
				<h2>Zapatillas<img src="images/zapatillas.png" align="left" id="pacamisa"> </h2>
				<br>
			...
			<div class="checkbox" id ="bloque">
				<h2>Zapatos<img src="images/zapatos.png" align="left" id="papolo"> </h2>
				<br><br>
				...
				<div class="checkbox4">
			<div class="checkbox" id ="bloque" >
				<h2>Sandalias <img src="images/sandalias.png" align="left" id="jersey"> </h2>
