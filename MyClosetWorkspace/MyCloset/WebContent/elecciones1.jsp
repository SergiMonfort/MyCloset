...
<div class = "topnav">
		...
		<div class = "checkbox1">
			<div class = "checkbox" id = "bloque1">
				<h2> Camiseta <img src = "images/camiseta.png" align = "left" id = "pacamiseta"> </h2>
				<br>
				...
				<h2> Camisa <img src = "images/camisa.png" align = "left" id = "pacamisa"> </h2>
				<br>
			...
			<div class = "checkbox" id = "bloque">
				<h2> Polo <img src = "images/polo.png" align = "left" id = "papolo"> </h2>
				<br> <br>
				...
				<div class = "checkbox4">
			<div class = "checkbox" id = "bloque">
				<h2> Jersey <img src = "images/jersey.png" align = "left" id = "jersey"> </h2>
