      ...
      <fieldset>
		...
		<div class="checkbox1">
			<div class="checkbox"  id ="bloque1">
				<h2>Jeans<img src="images/jeans.png" align="left" id="pacamiseta"  > </h2>
				<br>
				...
				<h2>Chinos<img src="images/chinos.png" align="left" id="pacamisa"> </h2>
				<br>
			...
			<div class="checkbox" id ="bloque">
				<h2>Bermudas<img src="images/bermudas.png" align="left" id="papolo"> </h2>
				<br><br>
				...
				<div class="checkbox4">
			<div class="checkbox" id ="bloque" >
				<h2>Jogger <img src="images/jogger.png" align="left" id="jersey"> </h2>
