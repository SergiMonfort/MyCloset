...
<div class="topnav">
		...
		<div class="checkbox1">
			<div class="checkbox"  id ="bloque1">
				...
				<input type="checkbox" name="casual" id="casualgris" value="gris">
				<label for="casualgris" id="gris">Gris  </label>
				
				<input type="checkbox" name="casual" id="casualcielo" value="cielo">
				<label for="casualcielo" id= "AzulCielo">Cielo</label>
				
				<input type="checkbox" name="casual" id="casualrosa" value="rosa">
				<label for="casualrosa" id= "rosa">Rosa</label>
				
				<input type="checkbox" name="casual" id="casualamarillo" value="amarillo">
				<label for="casualamarillo" id= "amarillo">Amarillo</label>
				
				<input type="checkbox" name="casual" id="casualnaranja" value="naranja">
				<label for="casualnaranja" id= "naranja">Naranja</label>
				
				<input type="checkbox" name="casual" id="casualnegro" value="negro">
				<label for="casualnegro" id= "negro">Negro</label>
				
				<input type="checkbox" name="casual" id="casualmarron" value="marron">
				<label for="casualmarron" id= "marron">Marron</label>
				
				<input type="checkbox" name="casual" id="casualmarino" value="marino">
				<label for="casualmarino" id ="azulmarino">Marino</label>
				
				<input type="checkbox" name="casual" id="casualverde" value="verde">
				<label for="casualverde" id ="verde">Verde</label>
				
				<input type="checkbox" name="casual" id="casualrojo" value="rojo">
				<label for="casualrojo" id ="rojo">Rojo</label>
				
				<input type="checkbox" name="casual" id="casualmorodo" value="morodo">
				...
				<h2>Zapatillas<img src="imagenes/zapatillas.png" align="left" id="pacamisa"> </h2>
				<br>
			...
			<div class="checkbox" id ="bloque">
				<h2>Zapatos<img src="imagenes/zapatos.png" align="left" id="papolo"> </h2>
				<br><br>
				...
				<div class="checkbox4">
			<div class="checkbox" id ="bloque" >
				<h2>Sandalias <img src="imagenes/sandalias.png" align="left" id="jersey"> </h2>
