      ...
      <fieldset>
		...
		<div class="checkbox1">
			<div class="checkbox"  id ="bloque1">
				<h2>Jeans<img src="imagenes/jeans.png" align="left" id="pacamiseta"  > </h2>
				<br>
				...
				<h2>Chinos<img src="imagenes/chinos.png" align="left" id="pacamisa"> </h2>
				<br>
			...
			<div class="checkbox" id ="bloque">
				<h2>Bermudas<img src="imagenes/bermudas.png" align="left" id="papolo"> </h2>
				<br><br>
				...
				<div class="checkbox4">
			<div class="checkbox" id ="bloque" >
				<h2>Jogger <img src="imagenes/jogger.png" align="left" id="jersey"> </h2>
